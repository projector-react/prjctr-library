...
export const AuthenticationApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        refreshApiAuthRefreshPost: async (
            options: AxiosRequestConfig = {}
        ): Promise<RequestArgs> => {
...
export const AuthenticationApiFp = function (configuration?: Configuration) {
    ...
    return {
        ...
        async loginApiAuthLoginPost(
            ...
            const localVarAxiosArgs = await localVarAxiosParamCreator.loginApiAuthLoginPost(
                userLoginModel,
                options
            );
        ...
        async logoutApiAuthLogoutPost(
            ...
            const localVarAxiosArgs = await localVarAxiosParamCreator.logoutApiAuthLogoutPost(
                options
            );
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
         ...
         * @throws {RequiredError}
         */
        async refreshApiAuthRefreshPost(
            options?: AxiosRequestConfig
        ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<any>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.refreshApiAuthRefreshPost(
                options
            );
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        ...
        async registerApiAuthRegisterPost(
            ...
            const localVarAxiosArgs = await localVarAxiosParamCreator.registerApiAuthRegisterPost(
                userDataModel,
                options
            );
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
...
export const AuthenticationApiFactory = function (
    ...
    return {
        ...
        loginApiAuthLoginPost(userLoginModel: UserLoginModel, options?: any): AxiosPromise<any> {
            return localVarFp
                .loginApiAuthLoginPost(userLoginModel, options)
        ...
        refreshApiAuthRefreshPost(options?: any): AxiosPromise<any> {
            return localVarFp
                .refreshApiAuthRefreshPost(options)
                .then(request => request(axios, basePath));
        },
        /**
         *
        ...
        registerApiAuthRegisterPost(
            ...
            return localVarFp
                .registerApiAuthRegisterPost(userDataModel, options)
                .then(request => request(axios, basePath));
        }
    };
};
...
export const CategoryApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getVideosByCategoryApiCategoryCategoryGet: async (
            category: Categories,
            options: AxiosRequestConfig = {}
        ): Promise<RequestArgs> => {
            // verify required parameter 'category' is not null or undefined
            assertParamExists('getVideosByCategoryApiCategoryCategoryGet', 'category', category);
            const localVarPath = `/api/category/{category}`.replace(
                `{${'category'}}`,
...
export const CategoryApiFp = function (configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getVideosByCategoryApiCategoryCategoryGet(
            category: Categories,
            options?: AxiosRequestConfig
        ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<VideoListModel>> {
            const localVarAxiosArgs =
                await localVarAxiosParamCreator.getVideosByCategoryApiCategoryCategoryGet(
                    category,
                    options
                );
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
...
export const CategoryApiFactory = function (
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getVideosByCategoryApiCategoryCategoryGet(
            category: Categories,
            options?: any
        ): AxiosPromise<VideoListModel> {
            return localVarFp
                .getVideosByCategoryApiCategoryCategoryGet(category, options)
                .then(request => request(axios, basePath));
        }
    };
};
...
export class CategoryApi extends BaseAPI {
     ...
     */
    public getVideosByCategoryApiCategoryCategoryGet(
        category: Categories,
        options?: AxiosRequestConfig
    ) {
...
export const MetadataApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getMetadataApiMetadataGet: async (
            options: AxiosRequestConfig = {}
        ): Promise<RequestArgs> => {
...
export const MetadataApiFp = function (configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getMetadataApiMetadataGet(
            options?: AxiosRequestConfig
        ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<any>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getMetadataApiMetadataGet(
                options
            );
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        }
...
export const MetadataApiFactory = function (
    ...
    return {
        ...
        getMetadataApiMetadataGet(options?: any): AxiosPromise<any> {
            return localVarFp
                .getMetadataApiMetadataGet(options)
                .then(request => request(axios, basePath));
        }
    };
};
...
export const PartnersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getVideosByCategoryApiPartnerPartnerGet: async (
            partner: Partners,
            options: AxiosRequestConfig = {}
        ): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/partner/{partner}`.replace(
                `{${'partner'}}`,
                encodeURIComponent(String(partner))
            );
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const PartnersApiFp = function (configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getVideosByCategoryApiPartnerPartnerGet(
            partner: Partners,
            options?: AxiosRequestConfig
        ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<any>> {
            const localVarAxiosArgs =
                await localVarAxiosParamCreator.getVideosByCategoryApiPartnerPartnerGet(
                    partner,
                    options
                );
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
 ...
 * @export
 */
export const PartnersApiFactory = function (
    configuration?: Configuration,
    basePath?: string,
    axios?: AxiosInstance
) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getVideosByCategoryApiPartnerPartnerGet(
            partner: Partners,
            options?: any
        ): AxiosPromise<any> {
            return localVarFp
                .getVideosByCategoryApiPartnerPartnerGet(partner, options)
                .then(request => request(axios, basePath));
        }
    };
};
...
export class PartnersApi extends BaseAPI {
     ...
     */
    public getVideosByCategoryApiPartnerPartnerGet(
        partner: Partners,
        options?: AxiosRequestConfig
    ) {
